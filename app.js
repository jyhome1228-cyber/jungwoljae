...
if(currentFile==='fortune-result.html'){
  ...
  setTimeout(()=>{const daily=document.createElement('script');daily.type='module';daily.src='./fortune-daily-v11.js?v=20260909-0750';document.body.appendChild(daily);},1200);
}
const toneScript=document.createElement('script');toneScript.src='./saju-tone-v11.js?v=20260909-0750';toneScript.defer=true;document.body.appendChild(toneScript);
